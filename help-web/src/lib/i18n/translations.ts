...
export const translations = {
  ...
  'dashboard.completed': { pl: 'Ukończone', en: 'Completed' },
  'dashboard.inProgress': { pl: 'W trakcie', en: 'In Progress' },
  'dashboard.notStarted': { pl: 'Nie rozpoczęto', en: 'Not Started' },
  'dashboard.noStatus': { pl: 'Brak statusu', en: 'No Status' },
  'dashboard.ofAll': { pl: 'wszystkich', en: 'of all' },
  'dashboard.statusDistribution': { pl: 'Rozkład statusów', en: 'Status Distribution' },
